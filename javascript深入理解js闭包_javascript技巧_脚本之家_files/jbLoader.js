...
tonglan1+='<li><A href="http://www.west.cn/services/CloudHost/?ads=jb512014" target=_blank><div style="width:237px;height:60px;position:relative;"><IMG alt="" src="http://files.jb51.net/image/west263_237.gif" width="237" height="60"><div style="position: absolute;z-index: 1;right: 0;bottom:0;background: url(http://img.jb51.net/skin/2016/images/gg.png) no-repeat bottom right;width: 237px;height: 60px;overflow: hidden;"></div></div></A></li>';
tonglan1+=ali237;
...
if("undefined" != typeof articleid){
    if(articleid!=null && ad_articlelist.indexOf(','+articleid+',') > 0){
		$('.tjz_qq:first').replaceWith('162150466 推荐<span class="pd5" style="color:red;">添加微信：hhnnn6</span><img data-baiduimageplus-ignore="" style="border:0;" border="0" align="absmiddle" src="http://files.jb51.net/image/aimeng.png" width="300" height="426" />');
		 $('.tjz_qq').replaceWith(' 162150466 推荐<span class="pd5" style="color:red;">添加微信：hhnnn6</span>');
    }
}